...
public class AboutUsTabletFragment extends Fragment {	
	...
	private void initBasicView() {
		...
		int width = (int) ((displayMetrics.widthPixels * 13 / 20
				- getActivity().getResources().getDimensionPixelSize(R.dimen.about_us_aboutapp_margin) * 5.0f)
				/ 4 - getActivity().getResources().getDimensionPixelSize(R.dimen.about_us_margin) * 2.0f);
		int height = width + 3 * getActivity().getResources().getDimensionPixelSize(R.dimen.about_us_margin) 
				+ getActivity().getResources().getDimensionPixelSize(R.dimen.about_us_title);
		...
		TableRow.LayoutParams FeedParams = new TableRow.LayoutParams
				(width + 2 * getActivity().getResources().getDimensionPixelSize(R.dimen.about_us_margin), height);
		FeedParams.setMargins(0,0, getActivity().getResources().getDimensionPixelSize(R.dimen.about_us_aboutapp_margin), 0);
		...
		TextView tvSubmit = new TextView(getActivity());
		ImageView ivSubmit= new ImageView(getActivity());
		RelativeLayout rlSubmit = new RelativeLayout(getActivity());		
        ...
        rlTvSubmitParams.setMargins(getActivity().getResources().getDimensionPixelSize(R.dimen.about_us_margin), 
				0, 
				getActivity().getResources().getDimensionPixelSize(R.dimen.about_us_margin), 
				getActivity().getResources().getDimensionPixelSize(R.dimen.about_us_margin));
        tvSubmit.setText(getActivity().getResources().getString(R.string.reader_submit));
        tvSubmit.setTextSize(getActivity().getResources().getDimensionPixelSize(R.dimen.about_us_title));
        tvSubmit.setTextColor(getActivity().getResources().getColor(R.color.about_us_tv));
        ...
        TableRow.LayoutParams SubmitParams = new TableRow.LayoutParams
				(width + 2 * getActivity().getResources().getDimensionPixelSize(R.dimen.about_us_margin), height);
        SubmitParams.setMargins(0,0, getActivity().getResources().getDimensionPixelSize(R.dimen.about_us_aboutapp_margin), 0);
		...
		TableRow.LayoutParams DeclareParams = new TableRow.LayoutParams
				(width + 2 * getActivity().getResources().getDimensionPixelSize(R.dimen.about_us_margin), height);
		DeclareParams.setMargins(0,0, getActivity().getResources().getDimensionPixelSize(R.dimen.about_us_aboutapp_margin), 0);
		...
		for(int i=0; i<appProject.size(); i+=columnNum){
			...
			for(int j=0; j<columnNum; j++){
				...
				if(index % columnNum == 0)
					Params.setMargins(0, 0, getActivity().getResources().getDimensionPixelSize(R.dimen.about_us_aboutapp_margin), 0);
				else
